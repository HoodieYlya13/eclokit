...
// Utility to get random views between 10k and 20k
const getRandomViews = () => Math.floor(Math.random() * (20000 - 10000 + 1) + 10000);
...
export const blogPosts: BlogPost[] = [
	...
	{
		slug: "travailler-argile-das-bases-essentielles",
		title: "Travailler l’argile avec DAS les bases essentielles",
		excerpt:
			"Le travail de l’argile séduit de plus en plus d’adeptes du DIY en Europe. Accessible, relaxant et créatif, il permet de réaliser des objets décoratifs, utilitaires ou artistiques.",
		content: `<p>Découvrez les bases techniques pour bien débuter le travail de l'argile avec la DAS.</p>`,
		author: {

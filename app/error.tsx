...
export default function GlobalError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
	return (
		...
		>
			...
			<h1 className="mt-6 text-7xl font-bold tracking-tight">Erreur</h1>
			<h2 className="mt-4 text-xl text-muted-foreground">Une erreur s'est produite</h2>
			<p className="mt-2 text-sm text-muted-foreground">
				Une erreur inattendue s'est produite. Veuillez réessayer ou retourner à la boutique.
			</p>

...
export const metadata: Metadata = {
	...
	description:
		"Cette page n'existe pas ou a été déplacée. Continuez vos achats pour trouver ce que vous cherchez.",
};
...
export default function NotFound() {
	return (
		...
		>
			...
			<h2 className="mt-4 text-xl text-muted-foreground">Page non trouvée</h2>
			<p className="mt-2 text-sm text-muted-foreground">
				Cette page n'existe pas ou a été déplacée. Mais notre boutique est toujours ouverte !
			</p>
			<YnsLink
				href="/"

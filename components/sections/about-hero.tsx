	...
	return (
		<section className="relative w-full min-h-dvh flex flex-col items-center justify-center pt-36 md:pt-48 pb-20 overflow-hidden">
			...
			<div className="relative w-full max-w-screen-2xl mx-auto px-6 md:px-12 z-10 text-center">
				<SectionHeader title={title} badge={introduction} centered inversed />
			</div>

			<div className="absolute left-[10%] bottom-[15%] size-24 pointer-events-none opacity-20 rotate-45 animate-pulse-slow">
				<svg
					className="size-full"
					fill="none"
					stroke="var(--primary)"

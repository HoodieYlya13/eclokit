	...
	return (
		<section className="py-24 px-6 md:px-12 w-full max-w-screen-2xl mx-auto border-t border-border">
			...
			<div className="max-w-3xl mx-auto text-center mb-16">
				<p className="text-muted-foreground italic leading-relaxed">{introText}</p>
			</div>
				...
				{commitments.map((item) => {
					...
					return (
						<div key={item.label} className="group flex flex-col items-center text-center">
							<div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-secondary transition-all duration-300 group-hover:bg-foreground group-hover:scale-110 shadow-lg shadow-primary/5">
								<Icon className="h-7 w-7 text-muted-foreground transition-colors group-hover:text-secondary" />
							</div>
